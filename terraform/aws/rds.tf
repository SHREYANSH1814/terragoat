...
resource "aws_backup_plan" "app5_backup_plan" {
  name = "app5-rds-cluster-backup-plan"
...
resource "aws_backup_selection" "app5_backup_selection" {
  name          = "app5-rds-cluster-backup-selection"
  iam_role_arn  = aws_iam_role.backup_role.arn
  backup_plan_id = aws_backup_plan.app5_backup_plan.id

  resources = [aws_rds_cluster.app5-rds-cluster.arn]
}

resource "aws_iam_role" "backup_role" {
  name = "app5_backup_role"
